namespace WeatherZapto
{
    public static class WeatherZaptoConstants
    {
        ...
        public const string UrlOWLocationZipCode = @"geo/1.0/zip?zip={zip code},{country code}&appid={API key}";
        public const string UrlOWLocationCity = @"geo/1.0/direct?q={city name},{state code},{country code}&limit={limit}&appid={API key}";
        ...
        public const string UrlLocationZipCode = @"location/zip={0}&country={1}";
        public const string UrlLocationCity = @"location/city={0}&state={1}&country={2}";
