...
if($LASTEXITCODE -eq 0)
{
    ...
    $result = docker build -t mickabdocker/weatherzaptowebserver:v1 -f ./WeatherZapto.WebServer/Dockerfile .
    ...
    if($LASTEXITCODE -eq 0)
    {
        ...
        $result = docker push mickabdocker/weatherzaptowebserver:v1
