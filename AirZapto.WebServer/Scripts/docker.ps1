...
if($LASTEXITCODE -eq 0)
{
    ...
    $result = docker build -t mickabdocker/airzaptowebserver:v3 -f ./AirZapto.WebServer/AirZapto.WebServer/Dockerfile .
    ...
    if($LASTEXITCODE -eq 0)
    {
        ...
        $result = docker push mickabdocker/airzaptowebserver:v3
