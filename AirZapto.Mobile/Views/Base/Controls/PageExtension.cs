    ...
    public static class PageExtension
    {
        ...
        public static async Task PushPageAsync(this Page mainPage, Page page, bool animated)
        {
            if (page != null)
            {
                ...
                {
                    if ((mainPage.Navigation.NavigationStack[^1] is CustomNavigationView) && (page is CustomNavigationView))
                    {
                        if ((mainPage.Navigation.NavigationStack[^1] as CustomNavigationView).GetType() == (page as CustomNavigationView).GetType())
                        {
