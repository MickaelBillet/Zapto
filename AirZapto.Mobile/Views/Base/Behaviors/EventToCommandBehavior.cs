...
namespace AirZapto.View.Behaviors
{
	public class EventToCommandBehavior : BindableBehavior<Xamarin.Forms.View>
	{
		...
		public static readonly BindableProperty EventArgsConverterParameterProperty = BindableProperty.Create("EventArgsConverterParameter", typeof(object), typeof(EventToCommandBehavior), null);
		...
		private void OnFired(object sender, EventArgs eventArgs)
		{
			...
			if (eventArgs != null && eventArgs != EventArgs.Empty && parameter == null)
			{
				parameter = eventArgs;
			...
			if (eventArgs is CheckedChangedEventArgs)
			{
				if ((Command.CanExecute(parameter) && ((CheckedChangedEventArgs)eventArgs).Value == true))
				{
