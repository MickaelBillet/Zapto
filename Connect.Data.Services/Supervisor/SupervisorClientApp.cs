...
namespace Connect.Data.Supervisors
{
    public sealed class SupervisorClientApps : ISupervisorClientApps
    {
        ...
        #region Constructor
        public SupervisorClientApps(IDataContextFactory dataContextFactory, IRepositoryFactory repositoryFactory, IConfiguration configuration)
        {
            ...
            if (context != null)
            {
                _lazyClientAppRepository = repositoryFactory.CreateRepository<ClientAppEntity>(context);
            }
        }
        #endregion
